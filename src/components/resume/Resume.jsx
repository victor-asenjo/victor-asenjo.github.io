          ...
          >
            ...
            <div className=" relative">
              ...
              <div className=" flex flex-col gap-1 border-2 border-yellow-400 shadow-[0px_0px_16px_1px_rgba(0,0,0,0.1)] p-3 rounded-lg">
                ...
                <span className=" text-[.9rem] font-semibold text-gray-500 sm:text-base">
                  FIB (Faculty of Computer Science of Barcelona) - UPC
                </span>
                <span className=" text-[.9rem] font-semibold text-yellow-500 sm:text-base">
                  2019 - 2023
                </span>
                <p className=" text-[.9rem] text-justify text-gray-500">
                  I have always loved being able to create projects that help and make life easier for people. What better way to do this than with technology?
                </p>
              </div>
            </div>
            ...
            <div className=" relative">
              ...
              <div className=" flex flex-col gap-1 border-2 border-yellow-400 shadow-[0px_0px_16px_1px_rgba(0,0,0,0.1)] p-3 rounded-lg">
                ...
                <span className=" text-[.9rem] font-semibold text-gray-500 sm:text-base">
                  INS Mercè Rodoreda, 08907, L'Hospitalet de Llobregat, Barcelona
                </span>
                <span className=" text-[.9rem] font-semibold text-yellow-500 sm:text-base">
                  2017 - 2019
                </span>
                <p className=" text-[.9rem] text-justify text-gray-500">
                  I have completed Technological scientist Baccalaureate at INS Mercè Rodoreda.
                </p>
              </div>
            </div>
            ...
            <div className=" relative">
              ...
              <div className=" flex flex-col gap-1 border-2 border-yellow-400 shadow-[0px_0px_16px_1px_rgba(0,0,0,0.1)] p-3 rounded-lg">
                ...
                <p className=" text-[.9rem] text-justify text-gray-500">
                  I did my Compulsory Secondary Education studies at IES Mercè Rodoreda with the best teachers I could have had.
                </p>
              </div>
            </div>
          </fieldset>
